    ...
    <div class="row justify-content-center"> <!-- Comando bootstrap que centraliza o conteúdo  -->
        <div class="col-md-8"> <!-- Esta é uma coluna bootstrap que ocupa 8 das 12 colunas disponíveis na grade, centralizando assim o formulário na página.  -->
            <div class="card"> <!-- Este é um cartão bootstrap que contém o formulário de cadastro.  -->
                <div class="card-header titulo">Editar Veículo:</div> <!-- Seção de cabeçalho do cartão, que contém o título "Cadastro:". -->
                ...
                success: function(response){
                    ...
                    confirmButtonText: "Ok",
                        ...
                        if (result.isConfirmed) {
                            ...
                            $("#cor").val("");
                            $("#marca").val("");
                            window.location.href = "{{ route('listar-veiculos') }}"; //Está acessando a propriedade href do objeto location do navegador, que contém o URL da página atual. E depois ele está gerando o URL completo para a rota chamada 'listar-veiculos'. 
                        }
                    });
                },
