    ...
    <div class="row justify-content-center"> <!-- Comando bootstrap que centraliza o conteúdo  -->
        <div class="col-md-8"> <!-- Esta é uma coluna bootstrap que ocupa 8 das 12 colunas disponíveis na grade, centralizando assim o formulário na página.  -->
            <div class="card"> <!-- Este é um cartão bootstrap que contém o formulário de cadastro.  -->
                <div class="card-header titulo">Cadastro Veículo:</div> <!-- Seção de cabeçalho do cartão, que contém o título "Cadastro Veículo:". -->
                ...
                <div class="card-body cadastro"> <!--  É a seção do corpo do cartão, que contém o formulário de cadastro. -->
                    <form id="formCadastro"> <!-- Este é o formulário HTML que enviará os dados para o servidor. O atributo method="POST" especifica que os dados serão enviados por meio de uma solicitação POST. O atributo action="" especifica o URL para o qual os dados serão enviados. -->
                        ...
                        <div class="form-group mb-2"> <!--  Este é um grupo de formulário bootstrap. -->
                            <label for="usuario">Usuário:</label>
                            <select class="form-control mt-2" name="usuario" id="usuario"> <!-- Adicionou um Select(que cria um menu de opções)-->
                                <option>Selecione</option> <!-- texto padrão que não possui um valor associado.-->
                                <option value="agatha">Agatha</option> <!-- Está definindo uma opção com um valor, nesse caso "agatha".-->
                                <option value="thiago">Thiago</option> <!-- Quando o usuário seleciona uma dessas opções e envia o formulário, o valor associado à opção selecionada será enviado para o servidor como parte dos dados do formulário.-->
                            </select>
                        </div>
